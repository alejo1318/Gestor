      ...
      <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Menores</span>
            ...
            <div class="br-pagebody">
                <div class="br-section-wrapper ">
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Fomulario de registro Menores</h6>
                    <div class="row mg-t-30 ">
                        <!-- botones -->
                        <div class="col-xl-3 ">
                            <div class="form-layout ">
                                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Menu</h6>
                                <div class="row">
                                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                  <button class="btn btn-secondary">Datos Iniciales</button>
                                  </div>
                                </div><!-- row -->
                                <div class="row mg-t-20">
                                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                  <button class="btn btn-secondary">Informacion Padres</button>
                                  </div>
                                </div>
                                <div class="row mg-t-20">
                                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                  <button class="btn btn-secondary">Concentimento</button>
                                  </div>
                                </div>
                                <div class="row mg-t-20">
                                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                  <button class="btn btn-secondary">Motivo consulta</button>
                                  </div>
                                </div>
                                <div class="row mg-t-20">
                                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                  <button class="btn btn-secondary">Datos familiares</button>
                                  </div>
                                </div>
                                <div class="row mg-t-20">
                                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                  <button class="btn btn-secondary">Antecedentes</button>
                                  </div>
                                </div>
                                <div class="row mg-t-20">
                                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                  <button class="btn btn-secondary">Formulario Diagnostico</button>
                                  </div>
                                </div>
                            </div><!-- form-layout -->
                        </div><!-- col-6  botones-->
